...
<style>
  body {
    ...
    background-color: #f9e8e8; /* light pink background */
    text-align: center;
    display: flex;
...
<body>
<img src="https://github.com/Rishabh56re/Mani.html/blob/main/kiss.gif" alt="Teddy Bear" width="150" class="teddy">
<h1>Mannii, do you love me?</h1>
<div>
  <button id="yes" onclick="showGirl();">Yes</button>
  <button id="no" onclick="increaseYes()">No</button>
</div>
<img src="https://github.com/Rishabh56re/Mani.html/blob/main/cuteboy.jpg" alt="Cute Girl" width="200" class="hidden" id="girlImage">
<script>
